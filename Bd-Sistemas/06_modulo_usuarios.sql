/* =============================================
   4. MODULO DE USUARIOS (Schema: usr)
   ============================================= */
...
BEGIN
    ...
    INSERT INTO usr.roles (nombre) VALUES ('USUARIO'), ('ADMIN');
END;
GO
...
BEGIN
    CREATE TABLE usr.clientes_publico (
        ...
        CONSTRAINT fk_clientes_paises FOREIGN KEY (id_pais) REFERENCES gral.paises(id_pais),
        CONSTRAINT fk_clientes_roles FOREIGN KEY (id_rol) REFERENCES usr.roles(id_rol),
        -- CORRECCION: Ahora funciona porque gral.estatus ya existe
        CONSTRAINT fk_clientes_estatus FOREIGN KEY (id_estatus) REFERENCES gral.estatus(id_estatus)
    );
END;
GO
...
BEGIN
    CREATE TABLE usr.usuarios (
        ...
        id_estatus INT NOT NULL DEFAULT 1,
        CONSTRAINT fk_usuarios_clientes FOREIGN KEY (id_cliente) REFERENCES usr.clientes_publico(id_cliente),
        CONSTRAINT fk_usuarios_estatus FOREIGN KEY (id_estatus) REFERENCES gral.estatus(id_estatus)
    );
END;
GO